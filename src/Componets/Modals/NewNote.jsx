...
function NewNote() {
  ...
  const onSubmit = () => {
    addNote(title, description, space);
    setOpenModal(false);
  };
    ...
    <Container>
      <Form>
        <TextBox>
          ...
          <textarea placeholder="..." className="titleStyle" value={title} onChange={onChangeTitle} />
        </TextBox>
        <TextBox>
          <Label>Descripción</Label>
          <textarea placeholder="..." className="descriptionStyle" value={description} onChange={onChangeDescription} />
        </TextBox>
        <Details>
          <StatusBox>
